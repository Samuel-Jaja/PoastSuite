...
namespace PoastSuite
{
    public static class Global
    {
        ...
        public static double Mark4 { get; set; }
        public static double Mark5 { get; set; }
        public static double Mark6 { get; set; }
        public static double Mark7 { get; set; }
        public static double Mark8 { get; set; }
        public static double Mark9 { get; set; }
        public static double Mark10 { get; set; }
        public static double Mark11 { get; set; }
        public static double Mark12 { get; set; }
        public static double Mark13 { get; set; }
        public static double Mark14 { get; set; }
        public static double Mark15 { get; set; }
        public static double Mark16 { get; set; }
        public static double Mark17 { get; set; }
        public static double Mark18 { get; set; }
        public static double Mark19 { get; set; }
        public static double Mark20 { get; set; }
        public static double Mark21 { get; set; }
        public static double Mark22 { get; set; }
        public static double Mark23 { get; set; }
        public static double Mark24 { get; set; }
        public static double Mark25 { get; set; }
        public static double Mark26 { get; set; }
        public static double Mark27 { get; set; }
        public static double Mark28 { get; set; }
        public static double Mark29 { get; set; }
        public static double Mark30 { get; set; }

        public static double TotalMarks { get; set; }
        public static double Score { get; set; }
        public static double TotalScore { get; set; }
